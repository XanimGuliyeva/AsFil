...
@section('body')
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="main_form">
                                                @csrf
                                                <input type="text" name="teyinat" placeholder="Təyinat sahəsi" class="form-control"><br>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($categories as $key=>$category)
                                        <tr id="{{$category->id}}">
                                            ...
                                            <td class="text-center">{{$category->teyinat}}</td>
    ...
    <script>
        ...
        $('.modal-footer').on('click','.btn-dark',function(){
            ...
            var teyinat = $('input[name=teyinat]').val().trim();
            $.ajax({
                type: "POST",
                url: "add_category",
                data: formData,
                ...
                success: function (response) {
                    if (response.message == 'success') {
                        ...
                        $('tbody').append('<tr id="' + response.id + '">' +
                            ...
                            '<td class="text-center">' + teyinat + '</td>\n' +
        ...
        $('#myConfirm').on("click", ".btn-danger" ,function()
        {
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    if(response.message == 'success')
                    {
                        toastr.success('Təyinat sahəsi silindi')
                        tr.remove();
                        sehifele();
                    }
                }
        ...
        $('#myModal2 .modal-footer').on('click','.btn-success',function() {
            ...
            var teyinat = $('#myModal2 input[name=teyinat]').val().trim();
            var tr = $('#'+id+'');
